...
class LocalAuthState {
  ...
  @override
  String toString() {
    return 'LocalAuthState{didAuthenticate: $didAuthenticate, status: $status, message: $message}';
  }
}
...
class LocalAuthNotifier extends StateNotifier<LocalAuthState> {
  ...
  authenticateUser({bool biometricOnly = false}) async {
...
final localAuthNotifierProvider = StateNotifierProvider<LocalAuthNotifier, LocalAuthState>((ref) {
